 ...
 */
public abstract class GenericModuleSupportFragment<COMPONENT> extends BaseSupportFragmentImpl implements CommonModuleSupportFragment,
        Injectable<COMPONENT>, BaseRouter{

    private static final Logger LOGGER = LoggerFactory.getLogger(GenericModuleSupportFragment.class);
