...
public class ReflectionUtils {
     ...
     */
    public static Class getGenericParameterClass(final Class actualClass, final Class genericClass, final int parameterIndex) throws NullPointerException, IllegalArgumentException {
        if (actualClass == null || genericClass == null) {
            throw new NullPointerException("\'actualClass\' or \'genericClass\' must be not null!!!");
        }
        ...
        return  Class.class.cast(result);
    }
